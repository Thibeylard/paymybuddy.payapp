...
public class ContactDAOSpringJdbcIT {
    ...
    public void Given_userIdAndContactMail_When_deleteContact_Then_correspondingElementDeletedToContactTable() throws Exception {
        ...
        Assertions.assertThat(contactTable).row(1)  // Second row is |1|3|
        ...
        assertThat(contactDAO.delete(4, "user1@mail.com")) // Params to delete row |4|1|
                .isTrue();
        Assertions.assertThat(contactTable).row(1)  // Second row |4|1| has been deleted. So third row |2|3| is supposed to be second now
